    ...
    private void RR(){
        ...
        while(true){
            ...
            try {
                ...
                if(TimeListSynchronization.canThreadTakeReadTimeVariable.get(this.processorID)){
                    ...
                    TimeListSynchronization.getInstance().waitTimeList();
                    TimeListSynchronization.canThreadTakeReadTimeVariable.set(this.processorID, false);
                    TimeListSynchronization.getInstance().signalTimeList();
                    continue;
                }
                TimeListSynchronization.getInstance().signalTimeList();
